...
print("Tas créé à partir de la liste")
print(elements)
# ajoute au tas
heapq.heappush(elements, 42)
# Ajout de l'élément 42
print("Ajout de l'élément 42 au tas")
print(elements)
...
heapq.heapreplace(elements, 23)
print("Tas après le remplacement par l'élément 23")
print(elements)
